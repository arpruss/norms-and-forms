...
impairment within certain abilities---for instance, one's mathematical skills might be dysfunctional, and yet the \textit{person} 
...
At the same time, there could turn out to be parts and skills such that the flourishing of the part always lines up with the
flourishing of the whole. We tend to think of morality to be like that. One is always better off for being more moral, and 
a failure of flourishing of one's morality is a failure of the organism as a whole.

How much of the above logically possible complexity is realized in humans is a question for further investigation. However,
