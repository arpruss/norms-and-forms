...
But there is some reason to think there may be normative accidents. 

Consider a view held by some contemporary Aristotelians that there are only three species of living organisms: plants,
non-rational animals and rational animals. One way to develop this view is to say that the substantial form of Rex the 
dog not only contains, in conditionalized form, all the norms applicable to dogs, like \textit{If you have canine DNA, you 
should have fur}, but also all the norms applicable to all the other non-rational animals, like \textit{If you have 
bird DNA, you should have feathers}. Another way, however, is to say that Rex, in addition to having the substantial 
form of non-rational animal, has an accidental form of caninity, which grounds the norms applicable to dogs. On this view,
Rex's forms do not contain norms for snakes or squirrels. While the conditionalized version of the view posits fewer 
forms, both as to types and as to instances, the substantial forms it posits have immense complexity. Thus it is far
from clear that Ockham's razor favors the conditionalized view given the three-species ontology. 

The three-species ontology of organisms appears implausible. However, an analogous point can be made about the human
species given the significant degree of diversity found within it.

??

??evolution--must have some implicit containment, or God?
