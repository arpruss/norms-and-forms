...
In general, utilitarianism, contractarianism and most versions of Kantianism\footnote{But see \citesasnoun{MaglioDissertation}.} focus on the agent's rationality, taking the details of the agent's humanity to provide no direct normative
...
wants to express their disagreement with the ancient Pythagorean preference for odd numbers over even ones.
...
One respond to the deadlift example by focusing on the distincion between capabilities and incapabilities,
and saying that having a capability of at least statistically normal degree or an incapability of at 
most statistically normal degree is healthy. But this is unsatisfactory, since a significantly above
average capability to involuntarily collapse from a small impact to the head is not healthy.

One might go for a partially statistical account of health as in \citeasnoun{BourseHealth}, where we have a non-statistical notion of the
directional function a bodily system---muscles are for contracting and skulls are for resisting impact---and
...
the individual's survival and reproduction that we care about. On this account, then, by pursuing health
we end up pursuing a mere proxy for what we care about.
...
cardiac health in some people with marginal cardiac dysfunction by promoting sugary drinks and thereby 
bringing down the population average or median of the function. Conversely, an intervention that improves the health of 
one subpopulation automatically decreases the health of other subpopulations by shifting the average or median
upward. This is absurd. Furthermore, the degree to which one must fall short of the statistical norm to count
