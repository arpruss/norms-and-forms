...
Health is a normative concept and cannot defined purely statistically~\cite{LennoxHealth}. Health is a bodily
good. Having a heart significantly
more efficient than average or being able to deadlift 400 kilograms is not necessarily bad for the body, and hence 
is not necessarily unhealthy. Health has a directionality. The ability to deadlift an enormous weight might 
be said to be supernormal, but its possessor not thereby abnormal, nor do 
is there a need of medical treatment to reduce their strength, as in \posscite{VonnegutHB} dystopian ``Harrison Bergeron'' 
story.

At the same time, health is not simply \textit{the} good of the body. There are many goods of the body besides health, such as
