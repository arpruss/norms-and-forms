...
\subsubsection{An argument for liberals concerning same-sex marriage}
...
Nonetheless, there may be some reason for the defender of same-sex marriage to prefer the natural relationship view. For consider that it need not be particularly
problematic if a state sponsored mens' and women's doubles tennis, but did not fund mixed doubles competition. Nor would it be invidious to sponsor mixed doubles without
funding non-mixed doubles. If we accept the natural relationship view, then it is easy to say how the marriage case differs from the tennis case, by noting, as in
our earlier argument, that there is a natural desire for marriage but not for tennis, and that in tennis the partner is more fungible than in marriage, so that it is
reasonable to say to the tennis player ``Just choose someone of a different sex'', but not reasonable to say this in the marriage case.
