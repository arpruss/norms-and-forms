...
we are \textit{just} physical bodies, or physical bodies with souls. All the previous arguments of this
...
Here is one such reason. There is a spectrum of very similar beings that can be given between a rock and any 
purely physical being---add a particle here, shift this one, etc. The functional changes between neighboring 
items in the spectrum from can be quite small. Yet persons have a qualitative dignity that does not appear to 
be something that one can generate by a seemingly insignificant change from something that lacks that dignity.???

??What about a spectrum of forms? Can have big chunked additions 
