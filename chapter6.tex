...
animal. The third path is brain views on which we are brains that are a proper part of a human animal. 
...
\textit{associated} with mammals, by ensoulment, constitution aor parthood.   Yet \dref{mammal} is by itself extremely plausible. 
