...
with the cerebrum, there are three possibilities for the cerebrumless body. Either it gains a new human form, or it gains some
other organismic form, or it is a formless heap of matter. 
...
If the cerebrumless body gains a new organismic form, we have something moderately puzzling, too: a non-human organism
...
The last option is that we have a formless heap of matter. This does not seem particularly puzzling. If the form departs,
by going along with the cerebrum, then formlessness would seem to be the obviously expected result, barring some special
reason to the contrary.

?? destruction of cerebrum
