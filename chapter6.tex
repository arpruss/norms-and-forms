...
defines the minimality of a system. One might try to do so by the number of particles, the number of atoms, the number of 
molecules, or the mass (the last is a little tricky, because we learn from Einstein that energy is a component in mass,
and the mass of a part then depends on the energy it has as a part of a larger whole).
