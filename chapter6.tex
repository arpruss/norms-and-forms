...
really exist---are real composites of parts. ?????so what?
...
Perhaps what makes the control voluntary, then, is that in voluntary control, the form enforces a connection between reasons 
and actions. ???????????
