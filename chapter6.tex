...
Begin with the well-known observation going back at least to \citeasnoun[Appendix]{Putnam} that simple causal systems, like the electrons buzzing inside a rock, can be re-interpreted as 
...
the generations subsequent to the selection.\footnote{For instance \citeasnounwithpages[p.~28]{Millikan1984}
...
Note that this version of the argument has two advantages over that given by \citeasnoun[Appendix]{Putnam}. First,
