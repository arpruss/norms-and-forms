...
We should all agree that it would be possible to have a communicative practice on which an assertoric utterance instead of expressing 
...
comprehensible within an Aristotelian framework: we can suppose that human nature makes some assertoric utterances fulfill us, others
...
values of the propositions, the values of assertoric utterances---whether just bad, neutral and good, or more fine-grained ones---are thereby
...
they cannot be vague either. And hence in the supervaluationist social practices described above, where assertoric utterances express a 
...
A second objection starts like this. Communicative practices of an assertoric sort that embody first-level vagueness are indeed possible. All we 
...
using old---and presumably vague---terms to introduce new ones. 

???assertions vs other stuff???
