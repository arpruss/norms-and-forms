...
\subsection{Blunt language}
I take it that we should all agree that it would be possible to have a communicative practice on which an assertoric utterance instead of expressing 
...
We can complicate things in various ways. We might, for instance, have a complex communicative practice on which instead of a 
zero-one distinction between propositions in and not in the expressed family, we have a continuum on which the utterance 
assigns a hermeneutic value to various propositions. Thus, ``Alice is rich'' might assign a high hermeneutic value
to the proposition that Alice has at least a million dollars, a significantly lower hermeneutic value to the propositions that 
she has at least a billion dollars and that she has at least a thousand dollars, and no hermeneutic value to the propositions that 
Alice has \textit{at most} a million dollars or that the sky is blue. The social practice then could have an axiology on which the value
of an utterance $u$ is the sum of the $u$-assigned hermeneutic values of the true propositions minus the sum of the $u$-assigned hermeneutic 
values of the false propositions divided by the sum of the hermeneutic values of all the propositions (obviously, something technical would
need to be done to take care of the possibility that infinitely many propositions have non-zero hermeneutic value). This would allow some 
propositions in the family to count for more, and would allow degrees of value. Thus, ``Alice is rich'' could be more valuable when Alice
has a billion than when Alice has a million, and could  have minimum value when Alice has only a penny because no proposition with 
non-zero hermeneutic value assigned by ``Alice is rich'' will be true when Alice has only a penny.

At the same time, it is very plausible that some of our utterances are not merely epistemically vague. An inquiry into whether three rocks can make 
...
precisification there is no answer. This fits well with the hypothesis that our everyday communicative practices are something 
like the ones described above.

However??

\subsection{An Aristotelian story}
...
Our nature can provide us with
sharpness in two ways. First, it can ground the facts about the propositions expressed by and illocutionary force of our utterances 
...
will at least partly ground the truth values.

But while the sharpness will simplify our logic, it does not do justice to our intuition that there is something gappy in
the truth values of sentences of ``These three rocks are a heap'' or ``Felix is a dommal''. In at least some such cases, 
we might do better to allow for some genune vagueness. One way to do that would be for the Aristotelian to allow for
first-order vagueness, while drawing the line at second-order vagueness. For instance, adapting a version of supervaluationism,
we might suppose that a sentence expresses a set of propositions. The sentence is supertrue when all the propositions in the 
set are true, superfalse when they are all false, and vague when some are true and some are false. But while for classical
supervaluationism it seems that vagueness reappears at the level of the question of what propositions are in the set---for
instance, is the proposition that there are at least seven rocks a member of the set of propositions expressed by ``There are
many rocks''---it presents no special difficulty for the Aristotelian to say that our nature grounds the answer to the questtion
of which propositions are in the set expressed by the sentence. After all, there was no necessity of positing any kind of
vagueness even at the first level, but we are allowing it in order to do justice ordinary intuitions. But our 
intuitions are surely far more trustworthy when they regard first-order sentences than when they regard metalinguistic
sentences like ``$s$ expresses a set containing $p$''. It is much less unpleasant to bite the bullet of denying vagueness
at the meta-level than to deny the vagueness of ``These three rocks are a heap.''

Furthermore, while we can allow first-order vagueness for sentences about heaps and baldness, we need not go on to allow for
vagueness with regard to the fundamental norms governing our behavior. Allowing such vagueness would suggest that there are 
many propositions expressed by ``This action is morally impermissible'' and this does not do justice to the supreme role that 
moral duty plays in governing our voluntary behavior---for then, presumably, one proposition would be attributing impermissibility$_1$
and another impermissibility$_2$, and so on, and which one would be supreme? (??backref)

If we go for such a hybrid view, however, then we still have a question of what to make of moral claims that depend on
the meaning of vague non-moral sentences. Suppose a physician offers to refund her fee if she fails to cure your baldness. 
During the course of treatment, you change from its being supertrue that you are bald to its being vaguely true that you are
bald. It seems plausible that it is supertrue that the physician morally owes you money if and only if you are still bald, and since
the it is vague whether you are now bald, it is vague whether the physician owes you money. But given the unavailability of multiple
disambiguations of ``morally ought'', this is not satisfactory. Instead, it seems we need a sharp answer. In the case of promises,
it is reasonable to look for facts relevant to that answer in our social practices surrounding promises. For we could imagine societies
where a promise to $\phi$ is fulfilled only by its being supertrue that the person has $\phi$ed, ones where its not being superfalse
would suffice for fulfillment, ones where the answer varies from context to context, and ones where the resolution is even more
complex.\footnote{For instance, one might require that by some contextually specified measure \textit{most} of the propositions 
in the set expressed by ``$x$ has $\phi$ed'' are true.} But we might also think that there is a default, overridable by society or 
the contracting parties, where ambiguities are to be resolved in favor of freedom, and hence unless otherwise specified, it is enough
that it not be superfalse that the agent has $\phi$ed for the promise to $\phi$ to be fulfilled.
