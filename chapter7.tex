...
However, it is very plausible that some of our everyday utterances are not merely epistemically vague. An inquiry into whether three rocks can make 
...
precisification there is no answer. This fits well with the hypothesis that our everyday communicative practices are somewhat 
like the ones described above. And there is nothing incoherent about that.

Now, our description of the practices presupposed that there are propositions that are simply true or false. ???Vicious regress?

Use promises to show that there can't be vagueness all the way down!!!??
