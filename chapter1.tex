...
there is a choice between a variety non-realism and a highly controversial metaphysics (see Chapter~\ref{ch:X}.\ref{sec:non-realism}
...
I do not have any particularly original argument for realism about norms. I find persuasive an argument based on particular
...
society's abhorrent views. And it is as indisputable as there being other minds that one is epistemically defective if one comes 
to believe in fairies solely to thumb one's nose at the scientific establishment, and this is true even if society agrees 
that we should so thumb our noses. Likewise, eating thumbtacks does not contribute to flourishing no matter how much one wants 
to eat them or how much one enjoys this due to a rewiring of one's pleasure system.??ref:McInerny A non-realist reader will say I am just thumping the table, of course. Indeed, I have thumped it, and now I will simply assume realism.

In the rest of this first chapter, we will do two things. First, I will sketch the central Aristotelian metaphysics in slightly
