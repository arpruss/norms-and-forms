...
like oak trees and human beings to be paradigm cases of substances??ref. Moreover, quantum mechanics gives one reason to
doubt that particles are substances, since one can have a superposition of states with different numbers of particles??ref,
whereas there should be a well-defined number of substances. 
