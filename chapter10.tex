...
????(but perhaps not in other universes, if we live in a multiverse with different universes having different laws). 
????are other universes more of an issue for non-Aristotelian pushy lawyers???
