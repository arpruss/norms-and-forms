...
wise person kidnapped to serve as an adviser~\parencite[\textit{Memorabilia} IV.2]{Xenophon}. And many a person would have escaped a broken
...
for it. However, this may be mistaken. If we think of substances as four-dimensional objects---spatiotemporal
...
temporal boundary be at death\footnote{For contrary views, see defenses of Epicurean arguments~\parencite{RosenbaumDeath} and \posscite{WilliamsDeath} pessimistic reflection on endless existence. Note that 
there is also an intermediate view on which our death is typically bad for us, but it wouldn't be good for us
to live forever---maybe a lifespan like 200 years, assuming full functioning throughout it, would be best.}

, and hence points towards life after death given Aristotelian optimism.} It is plausible that typical human cells have 
...
might fully flourish. This would allow an Aristotelian to accept a weakened version of the mere-difference view
of disability~\parencite{BarnesDisability} on which persons with significant disabilities can nonetheless
be fully flourishing. For the Aristotelian can allow that disability constitutes the failure of a part or aspect 
of the person to flourish, without thereby compromising flourishing of the whole. 

Indeed, there could be cases where the failure of flourishing of a part might not even decrease the flourishing
of the whole. Going back to Sally, perhaps 37 teeth is better than 38 (maybe 37 makes for better fit within the jaw),
...
the principle of causal finitism~\parencite{KoonsKalaam,PrussInfinity}. Furthermore, each organism would always have infinitely 
...
It is, parenthetically, interesting to note that this way of thinking of teleology complicates the well-known 
Kantian argument for why we should believe in 
an afterlife~\parencite{Surprenant}. On this argument, we are unable to achieve complete virtue in this life, but since we cannot aim at
...
is achievable. However, a critic might use the above understanding of teleology to defend the idea that we have an unlimited 
...
be a pure gift. This seems intelligible, and may well be attractive to theologians of a Lutheran bent.
...
\section{Individual or shared forms?}\label{sec:indform}
\subsection{Platonism and two Aristotelian views}
There is a classic debate whether Aristotle thinks forms are individual---numerically different ones for different members of 
the same kind---or jointly shared by all members of the same kind~\parencite{LesherAristotle,HartmanAristotle,FineAristotle}. The shared form view at first sight seems rather 
more Platonic than Aristotelian, but as long as the shared form is immanent in the individuals and governs their functioning, the view can count as Aristotelian. In any case, it is now time to compare an individual-forms Aristotelianism,
...
forms, a view held by some medieval thinkers.\footnote{I am grateful to Bryan Reece for this observation.} Since all the applications in this book are 
handled by the individual immanent forms on their own, the question of whether additionally there are shared universals
can be bracketed. I will thus stipulate the individual forms view to be that there are \textit{at least} individual
immanent forms, and take the shared universals and Platonist views to include a denial of such individual forms.

All three views have a robust view of human nature, whether this nature be a Platonic universal, a shared immanent form, 
or an individual form. All three views can give a grounding to answers to Mersenne questions about normative 
domains, and thus secure many of the normative applications of our theory of a robust human nature. So far we have
a tie. But there
are applications where the tie may be broken.

\subsection{Mind}
If we follow Aristotelian tradition and identify the mind with the form (or some aspects of the form), then the shared form and Platonist
views lead to Averroes' theory that we all have the same mind. If the will is part of the mind, then we get absurd consequences
about the lack of personal responsibility for our action, and in any case, the view is famously counterintuitive. However, 
there are two reasons this argument may not fully convince a contemporary Aristotelian or Platonist metaphysician to embrace an individual
forms view. 
...
The arguments of this section do not apply to the Platonic view, unless one thinks that Platonic
properties are parts of the individuals that instantiate them. But they will apply to the Aristotelian
shared form view, on which our form is a part of us. 

Our form is not just a part of us, then, but arguably the most important part of us. Thus, you and I 
have our most important part in common on a shared form view. This is intuitively both attractive and unattractive ethically. 
...
For evolution to
work with Aristotelian forms, sometimes organisms of one metaphysical
...
There may also be some reason to prefer either Aristotelian view to the Platonist one
insofar as the Aristotelian views might give a more direct account of at least some of 
...
tend to go right. Granted we will see in ??forwardref there are limitations to this 
...
this possible. Furthermore, the phenomenology of moral motivation is that sometimes we feel ``the norms'' pulling
on us. An Aristotelian view not only lets us take this ``pull'' quite seriously---the norms are aspects of our
causally efficacious nature which impel us to act teleologically---and to include it among the grounds for our knowledge
of our teleology.

Indeed, worries about knowledge of Platonic abstracta are one of the main reasons why many contemporary
philosophers reject Platonic views~\parencite{FieldRealism}. Theism might be able to help here---God perhaps
...
facts as that one should proportion belief to evidence or that one should treat others with respect 
does not involve divine illumination. 
After all, a plausible ``incarnational'' theological insight is that if God exists, then God likes to work through creatures
...
And likewise God lets things happen according to the laws of nature rather than directly micromanaging things.
Further, methodologically it seems plausible that we should minimize invocations of God, so that we can engage
in serious scientific epistemology. Plus, it is
attractive to be able to save the phenomenology of seeing norms in and through the behavior of others and ourselves.
...
active area of research among Aristotelian philosophers of science, and a number of options are available~\parencite{KoonsPrime,PrussTraveling,SimpsonCosmic,SimpsonQPCM,SimpsonKoons}.
...
been co-located with you prior to the branch split as in the Many Minds interpretation of quantum mechanics~\parencite{AlbertLoewer} inhabits ``your'' position in the tails branch.}}
...
that most of the time the chances will be irrational numbers.} There are, of course, multiple ways to dispute this argument~\parencite{Vaidman,DeutschProbab,WallaceEverett}, but I will take the argument to provide significant support for the asymmetric metaphysical options. 
...
This fits neatly with an ontology on which we have a global substance grounding the wavefunction and agents (as
well as perhaps other substances) that move around in the multiverse, as on many-minds~\parencite{AlbertLoewer} and traveling minds/substances~\parencite{BarrettSingle,PrussTraveling} interpretations of quantum mechanics.
...
reality if the situations that trigger collapse are themselves described by the wavefunction. Earlier collapse interpretations like Wigner's had collapse triggered by conscious observation~\parencite{WignerCollapse}. This appears to require the prior existence of an observer. But if we think about 
...
More recent collapse interpretations coming from physicists, such as Ghirardi–Rimini–Weber theory~\parencite{GRW}, have collapse get triggered discretely or continuously by physical facts about the wavefunction. This is compatible with the wavefunction being a 
complete description of physical reality. These theories are empirically testable, but have not yet been sufficiently
tested. If we find such a theory to be correct, an Aristotelian view that posits additional macroscopic substances 
...
arguments against physicalism in the theory of mind~\parenciteeg{ChalmersConscious} lend support to a richer ontology.
...
\section{Pushiness and conclusions}
Are forms pushy? Do they affect the actual empirical behavior of the particles in the bodies of the organisms governed by them?
Or is the role of the forms purely metaphysical and normative, helping to account for identity across time??backref
and the broad variety of normative phenomena surveyed in Chapters??backref? This would already be a robust metaphysical
view. Is it enough?

There are multiple reasons to suppose a normative Aristotelianism is not enough, and the forms should be pushy. The first is that, as we saw in ??backref, this is what 
gives us the distinctive Aristotelian solution to the question of how laws of nature work. 

The second is the attraction of the Aristotelian interpretations of quantum mechanics in ??backref.

A third reason to suppose forms to be pushy would be to identify our form as soul, and hence a central ground 
of our mental life. If our soul does not affect our empirical behavior, then we run the danger of some variety of epiphenomenalism.\footnote{Though there may be a way to avoid that~\parencite{PrussRickabaugh}.}

And the fourth, and probably strongest, reason is that pushy forms fit better with Aristotelian optimism. We might 
suppose it is part of 
the nature of a form that it have a tendency to push the substance that it is a form of toward the behavior 
that the norm requires. This would nicely explain why the typical behavior or state of an entity is evidence for 
a norm---why it is a merely skeptical worry to suppose that perhaps sheep ought to be three-legged.  Furthermore,
the most attractive story of how our moral intuitions yield knowledge is likely one on which our form pushes us 
to have these moral intuitions, indeed a story on which our form grounds conscience. If we identify form with soul,
this story fits with what what is likely a common human intuition, namely that there is a connection between the 
puzzling phenomena of conscience and soul. 

The best picture of the humanly significant world that we have, taking into account a realism about the vast complexity of 
normative phenomena, as well as a number of metaphysical considerations appears to be a robustly Aristotelian
account on which each of us has a \textit{human form}, a constituent that not only specifies how to behave but that
pushes us to be the best version of ourselves. This is our soul, indeed our spirit.
