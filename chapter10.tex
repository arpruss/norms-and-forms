...
There are three main problems with axiarchic principle explanations.
...
Second, more seriously, axiarchic principles appear to lead to modal collapse. If metaphysical principles require everything to be 
for the best, then it seems that everything must be the way it is. 

There are at least three potential ways out of the modal collapse objection. The first is Leibniz's solution, which is to suppose two 
different kinds of modality. ??

The second response is to allow for ties or incommensurables. ??

The third is to limit the scope of axiarchic principles to producing what one might call the best \textit{framework} for a world. ??

Third, we have the problem of evil. ???
