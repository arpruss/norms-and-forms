...
In addition to optimism about behavior, it seems we additionally need optimism about our intuitions. We can try to derive 
...
??where are the boundaries between things of different types
