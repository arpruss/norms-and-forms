...
\ditem{branch-heads-2}{You go to the heads branch and someone else inhabits ``your'' position in the tails branch.}
...
the remaining two options). Thus, on a no-collapse view we have good reason to think there has to be more to reality 
