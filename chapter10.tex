...
\section{Explanations of moral norms}\label{sec:moral-explanation}
\subsection{A pattern of explanation of norms}
...
This section offers a voluntaristic divine selection model of explanation of norms. But there are at least two 
other models available. One of them is more voluntaristic and the other is less voluntaristic. We proceed to 
examine them.

\subsection{Creation of forms}
The selection model is based on God's choice of which form to instantiate. But we can go further: we can suppose that God 
actually creates the forms themselves. ??

\subsection{Participation}

??two types -- limit on forms, and divine choice
