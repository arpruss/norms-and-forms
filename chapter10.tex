...
with square circles, and so on---and, second, we could require the worlds to be \textit{logically} coherent, even if 
...
Now suppose we constrain worlds logically.??? what's that mean? my paper against Swinburne??
