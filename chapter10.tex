...
On all three views, God selects from that field of possibilities some forms that will be instantiated, and maybe some forms
that creatures can cause to be instantiated. ??


it is plausible to think that while the forms do not literally 
exist uninstantiated, God has something like ideas of the forms in his mind. 

\subsection{Participation}

But there is one other way that we could have a theistic explanation of normative features of forms.??
