...
A suggestion from the Aristotelian tradition is to connect reasons and norms with goods. To a first approximation, we might say 
that an (internal) reason for a behavior is a belief about the behavior being good, and then we could say that a necessary 
condition for a behavior being voluntary is that it comes from such a reason. ???
