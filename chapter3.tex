...
A Natural Law metaethics on which for an action to be right is for it to be a proper exercise of the will\footnote{Or 
the goodness of the will, as per \citeasnoun{FootNG}.} according to our nature
...
\subsection{Internality of morality}\label{sec:ethics-internalism}
...
Plato argued that that virtue is the center of our flourishing on the plausible grounds that moral virtue is the health 
of the soul~\parencite[\textit{Republic}, 444e]{PlatoRepublic}. What makes this argument an appealing invitation to moral virtue is that health is an internal good of 
...
likely to be deeply planted in you.\footnote{An alternative is the idea that higher-order values and
ideas should take precedence over lower-order ones~\parencitecf{FrankfurtHigherOrder}. Thus, if Bob believes that Alice should not get the benefit
...
That Natural Law makes the source of morality be literally a part of each of human being also makes it more
plausible than contemporary non-naturalist Platonist-style theories~\parenciteeg{ShaferLandau}, and divine command theory, on which the source 
of morality is found in  an objective reality outside of us---in a heaven, Platonic or theistic---that we 
...
them---they are immanent universals~\parencite{ArmstrongWorld}. Such Platonists can also say that the source of morality is truly a part of us. As \citeasnounwithpages{OckhamBoehner}{p.~39} vividly argued by noting that then Christ in heaven has a component---namely,
\textit{humanity}---in common with Judas in hell, it is somewhat implausible to think that all human beings literally overlap, 
but philosophers are used to biting such bullets. In Section~\ref{ch:details}.\ref{sec:indforms}, we will discuss the Aristotelian version of this theory
...
An ethics grounded in our natures has something in common with both internalism and externalism. Like in internalism,
fundamental ethical truths are grounded in facts wholly about us. But these facts about us are, like in externalism,
not directly available to consciousness. They need to be teased in Aristotelian methodology out by looking for an
elegant moral theory that reconciles the most plausible insights of virtuous agents and ourselves and that fits 
well with a picture of us as an animal whose form of life is what it is.

\subsection{What are moral or rational norms?}\label{sec:moral-functionalism}
...
comes from such a good-regarding reason. This, of course, raises the infamous problem of in-the-right-way causation. A behavior can be deviantly caused by a reason
without being voluntary. Davidson's famous example is the climber who wishes to lose the burden of holding up another person on a rope, intends to drop the other, and the desire to do so ``might so unnerve him'' that the rope slips~\parencite[p.~79]{DavidsonEssays}. Whatever reason 
the climber had for the dropping is the cause of the dropping, but the dropping is involuntary. Aristotelian metaphysics does, however, seem
...
world. And of course modal fatalism is not only highly counterintuitive but also does not allow one to do
any justice to the appearance of contingency in all the parameters we have been identifying in this book---or
in Mersenne's original observations about astronomical objects~\parencite[pp.~97--98,282--283]{MersenneImpiety}.
...
our occasional errors are justification for skepticism about the physical world, \textit{pace} \citeasnoun{DescartesMeditations}.
...
least justifiedly believe it won't. To get skepticism, one would need the skeptical scenario to be fairly
...
\textit{agent} languish is a thought too many~\parencitecf{WilliamsPCM}. Therefore, the argument goes, we should opt for an other-centered metaethics.
...
twin. That won't help with the God case, at least not within classical theism, since God is traditionally and plausibly thought of as a necessary 
being.\footnote{\citeasnoun{Findlay1948} gives a convincing case that God would have to be a necessary being, but 
because he does not have a distinction between narrowly logical necessity and the broadly logical necessity of
post-Kripkean metaphysics, he thinks this refutes the existence of God.}
 Furthermore, the intuition that I am responding to is that there is something particularly centered
...
respect to the will, but is full of ignorance, in great pain, and lying in a bed of vomit~\parencitecfwithpages{Vlastos1991}{215}, the agent
...
Furthermore, virtuous agents rarely aim at 
rightness as such; indeed the literature on moral fetishism insists, I believe excessively, that they
never do so~\parencite[p.~75]{SmithMoralProblem}. Instead, virtuous agents aim at thicker right-making features of an action, such as its being an expression
...
probabilistic grounds, it seems plausible that they are acting for the sake of rightness as such.\footnote{In fact, 
\citeasnoun{Weatherson2014} has used this to argue against avoiding moral risks---avoiding performing actions
which have a non-negligible probability of being wrong. But that one should avoid moral risks once the degree of
wrongness is sufficient is so plausible that it seems
...
about getting one's good. This is something that our altruistic paired aliens could do.\footnote{See also 
\citeasnoun{HowardFetishism}.}
...
But nonetheless, someone who refuses to make the sacrifice is typically not to be blamed. Thus there are ``actions
that go beyond duty''~\parencite[p.~209]{Urmson}, which we call ``supererogatory''. These are actions that are
morally better than their omission, but nonetheless their omission is not a bad thing.
...
individual utilities with \textit{equal} weights. But as we saw (Sections~\ref{sec:act-util}--\ref{sec:rule-util}) there are serious problems with
utilitarianism as a solution to Mersenne problems. And indeed, the equal weight part of the view is itself implausible. Suppose that 
...
sophisticated pleasures or higher order desires. If equal weighting of sutilities
...
short of deserving the death penalty, and the murder of a complete innocent deserves a greater punishment---if not in law, then in public opinion~\parencitecf{MillUtilitarianism}. Similarly, it seems clear that we should make a greater effort to stop the murder of a person
...
things, but nonetheless we differ in this valuable thing---for some of us may have DNA that better codes for, say, musicality, and others have DNA that codes less well for musicality~\parencite{WAGUM}. Thus our being human on a DNA standard is constituted by a variety of independently valuable genetic features,
...
\section{Outlandish paradoxes}\label{sec:outlandish1}
...
Garden for her greed. Either way, she gets to eat whatever pieces she has taken. \parencite{AEH2004}
\end{quote}
...
There have been various realist attempts to defuse such paradoxes\footnote{For an excellent critical survey,
see \citeasnounwithpages{Carlsmith}{Chapter~3}.}, and a defender of human nature as the
foundation of ethics can accept any of them as well as any other ethical realist. However, there is also a simple and highly intuitive 
...
is typically promoted by the requirement, even if all the details of the moral rule cannot be logically derived from that reason. Compare how in the American Constitution, copyright and patent law is expressly justified by the value of  
of ``the Progress of Science and useful Arts''~\parencite[Sect.~8]{USConst}. Thus a prohibition on killing the innocent promotes respect for the sacredness of life,
...
A similar point can be made about outlandish epistemological paradoxes.
 On the natural law epistemology that we will discuss in Chapter~\ref{ch:epistemology}, we should not expect our nature to give us guidance, or at least satisfactory guidance, 
in situations too far out of the human environment.\footnote{This might give a different resolution
to the epistemological paradoxes of infinity in \citeasnounwithpages{PrussInfinity}{Chapter~5}.}
 And while in ethics there are at least two common anthropocentric alternatives to natural law, contractarianism and divine command, in epistemology anthropocentric alternatives are harder to find.
...
More will be said in Section~\ref{ch:God}.\ref{sec:outlandish} about outlandish scenarios.

\section{The mystery of life forms}\label{sec:life-forms}
\citeasnoun{ThompsonRepresentation} and \citeasnoun{FootNG} have famously defended an Aristotelian picture of the 
normative life
of humans and other organisms in terms of ``natural goodness'' and ``life forms''. On this picture, there are
``Aristotelian categoricals'' about a species' ``life form'', such as ``Sheep have four legs'' and ``Humans keep
their promises.'' These categoricals are not equivalent to any statistically quantified claim, but are
normative, while at the same time being thoroughly factual. Foot further wants to distinguish those claims
that are tied to the species' teleological striving for species survival as indicative of natural goodness.
But at the same time, the Thompson and Foot approach to this strives to avoid the robust Aristotelian metaphysics
of form. 

The Aristotelian theory I am defending can agree with much of this story, but will insist that a robust metaphysics of
form provides the best answer to the mystery of what makes such categoricals or teleological attributions be true.
Here is one way to highlight the mystery. Imagine a stellar system $S'$ which is a particle-by-particle copy of our
Solar System $S$, in all of its evolutionary history. For simplicity, take $S'$ to be embedded in our universe, with the same laws of nature. We now 
have two questions, with all but one combination of answers pointing towards the need for something 
metaphysically robust about life forms---something more like the forms of Aristotle---and the one remaining
combination being quite problematic for the normative realist, which our life form theorists are.
\ditem{QBehav}{Is it possible that the oak-like, sheep-like and human-like things in $S'$ in fact have
different empirical behavioral tendencies from the oaks, sheep and people of $S$?}
\ditem{QNorm}{Is it possible that there are different norms governing the oak-like, sheep-like 
and human-like things in $S'$ from those governing the oaks, sheep and people of $S$?}

Suppose the answer to \dref{QBehav} is positive, regardless of what the answer to \dref{QNorm} is. Then we have a strong causal anti-reductionism on which the empirical behavior of living
things does not supervene on the laws of nature and the arrangement of particles. In the universe we have imagined
where both $S$ and $S'$ are embedded, there must then be something different between the oak-like, sheep-like
and human-like things in $S'$ and the oaks, sheep and humans of $S$, even though their particles are arranged the
same way. What is that difference? The robust Aristotelian can point towards the forms, and insist that what grounds
the possibility of such a behavioral difference are the differences in forms. These forms are indeed metaphysically
robust: they move particles about in a different way between the two universes. Further, there is something attractive 
about making the very same thing be responsible for the behavior and for the norms, because this can allow for
the optimistic thought that behavior tends to reflect norms, without which skepticism about forms is likely.

Suppose now that the answer to \dref{QBehav} is negative while that to \dref{QNorm} is positive. Then  
we have a strong \textit{normative} anti-reductionism: the norms governing mid-sized critters do not supervene 
on the arrangements of particle and the behaviors of the critters. For by the negative answer to \dref{QBehav},
the behaviors must be the same between $S$ and $S'$, while the norms can be different. We thus need something
to distinguish the life-forms of the critters in $S$ and $S'$, and it is clear that the distinction here must
be something rather mysterious. Indeed, if we humans were to look at the critters in $S'$, we would presumably
make incorrect judgments about their life forms precisely in those cases where we get right normative facts
the life forms of the critters of the Solar System and where the normative facts in $S'$ are different. What
makes for the difference? Again, the robust Aristotelian has a nice answer: the metaphysical components known
as forms do.

However, it is also worth noting
that the combination of a negative answer to \dref{QBehav} and a positive answer to \dref{QNorm} endangers
Aristotelian optimism, and in general is apt to lead to normative skepticism, unless there are constraints
on how large a normative deviation between $S$ and $S'$ is possible or at least probable. And if there are
such constraints, then they may motivate one to posit a further element of metaphysical robustness in the forms:
namely that the forms constrain what range of behavior is possible or probable given the normative features in
the form.

Finally, we have the final combination where the answer to both questions in negative. This combination is, of course,
going to be appealing to those who like reductionistic theories, and it may appear that this combination is the
best bet for an Aristotelian ethicist who wants to avoid controversial non-naturalistic metaphysics. After all,
on this combination, the laws of physics, particle arrangements and behaviors of organisms necessitate the normative
facts governing the organisms. But this last combination is highly problematic for a moral realist in light of
the arguments in the previous chapter (and similar arguments in Chapter~\ref{ch:applied-ethics}). For the complexity of
morality brought out by the Mersenne questions in the previous chapter makes it very likely that the function from
the laws of physics, particle arrangements and organic behaviors to norms is extremely complex with many seemingly
arbitrary parameters, to such a degree that this function is a very implausible candidate for necessity.

Thus, the no-no combination of answers to \dref{QBehav} and \dref{QNorm} appears untenable given moral realism,
while yes-yes, yes-no and no-yes answers all point towards the need for something metaphysically robust like
...
norms, many of them highlighted in Chapter~\ref{ch:ethics}, make such a Pollyannaish expectation of epistemic
...
It is also worth noting that an optimistic Aristotelian will think there is a harmony between our
desires and intuitions and the norms of our nature. Thus even though what is natural for our will
grounds what is right or wrong for us to do, the epistemic order can run in the other direction. We 
know that it is wrong for us for us to make false promises, and given the Aristotelian meta-ethics
we conclude that therefore it is unnatural for us to will to make a false promise, even though
the wrongness is grounded in naturalness. Indeed this is just a case of the
general Aristotelian phenomenon that epistemically we proceed from what is more knowable for us to what is more
knowable in itself~\parencite[I.1]{AristotlePhys14}.

what is first in itself (the metaphysical ground) is 
