...
temporary harm done to it by the robbery. 
...
the bee's activity (we may not wish to call it a ``will''). But this does not make the bee in any objectionable
way selfish. Why should it then become selfish if we replace the driver with the human will?
