...
(SET) that \textit{all} material substances are \textit{subatomic} in size at the beginning and end of their lives, 
...
moving with a constant sub-light velocity (i.e., undergoing sub-light inertial motion), there is a reference frame or coordinate systematic according to which that object 
...
spacelike hyperplane. A reference frame $F$ then divides up spacetime into a family of parallel spacelike hyperplanes
such that two points of spacetime are simultaneous according to $F$ provided that they lie on the same hyperplane. 
Conversely, given any spacelike hyperplane, we can form the set of all the hyperplanes parallel to it, and this 
set then defines the simultaneity relation for some reference frame. 
...
\subsection{A geometric argument for SBT}
????
