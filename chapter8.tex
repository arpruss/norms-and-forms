...
way for the chance of heads to be $1/2$. 

Here is one sketch of a suggestion. Suppose that we have a language $\scr L$ whose vocabulary can express all the fundamental physical concepts acceptable to 
...
The details are doubtless very difficult. 
