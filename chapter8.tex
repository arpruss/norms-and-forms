...
But it is worth noting that even the seemingly innocent example \dref{DN1}--\dref{DN3} has a crucial problem, which suggests that
...
\ditem{mDN3}{So, the sun attracts gravitationally.}
...
the sun's attracting gravitationally was a partial ground of \dref{DN1}, it seems to also be a partial ground of \dref{mDN1}, 
...
The proposition \dref{mDM1} in $w_M$ is then grounded in part in the fact that there is one more massive object
...
Yet that fact is explanatorily prior to \dref{mDM1}, which in turn is explanatorily prior to the sun's attractiveness.
...
As far as it goes, this point is correct. However, the Humean is not off the hook for making deductive predictions about contingent
