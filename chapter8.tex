...
being zero and truth being one)---perhaps a measure according to some standard scoring rule.??backref
...
That said, there is a complication. Arguments in Section~\ref{ch:IX}.??forwardref will make it plausible that on an
...
however, that earlier in his career, Aristotle did allow substances to be parts of subsatnces.}(??cross-refs) But then if a rabbit is a substance, the electrons in
