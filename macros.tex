...
\def\posscite#1{\citeauthor{#1}'s~(\citeyear{#1})}
\def\citebyname#1{\citeauthor{#1}~(\citeyear{#1})}
\def\citeasnoun#1{\citeauthor{#1}~(\citeyear{#1})}
\def\citebynamewithpages#1#2{\citeauthor{#1}~(\citeyear{#1}, #2)}
\def\citeasnounwithpages#1#2{\citeauthor{#1}~(\citeyear{#1}, #2)}
\def\parencitecf#1{(cf.\ \citeauthor{#1}, \citeyear{#1})}
\def\parenciteeg#1{(e.g.\ \citeauthor{#1}, \citeyear{#1})}
\def\parencitecfwithpages#1#2{(cf.\ \citeauthor{#1}, \citeyear{#1}, #2)}
