...
store for ice cream. And we have the Mersenne question of why the switchover happens where it does.
...
And even if one could give some such precise definitions, we would still have
the Mersenne problem of why \textit{this} definition corresponds with true value rather than some other. 



\subsubsection{A miscellany of other cases}
