...
relevant.  \citeasnoun[II-II Q64 A7]{AquinasST}, for instance, held that a private individual is not permitted to intend the death of 
an assailant.}
...
or the right, rather than by some variant property, would be entirely arbitrary. As \citeasnoun[p.~265--266]{SchoenfieldVagueness} observes, it is absurd
to think that linguistic usage settles the question of the permissibility of abortion, and adding knowledge of
the correct semantic theory to the facts of linguistic usage should not help either.\footnote{\citeasnounwithpages{HawthorneMoralVagueness} criticizes Schoenfield by observing that it is not enough on epistemicism to know the patterns of linguistic usage---one
