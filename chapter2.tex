...
Political philosophy provides a number of examples. Consider the constitution problem. A state has a written or unwritten
...
traffic regulations of the Nazi state were legitimate). 

One may wonder why questions about the legitimacy of a political system are being raised as part of a discussion of ethical
questions. There are two reasons. First, we have a moral duty to obey the commands of a legitimate state. Second, only a 
legitimate state has the right to make certain kinds of onerous demands on its population. ??anarchism

Some readers will disagree with a number of the examples I gave. Double Effect, for instance, is quite controversial. But it seems
