...
We will evaluate epistemicism in greater detail in ??forward, and even defend a version of it. However, ``better'' and ``bald'' are disanalogous. For there is no
...
of the norms involved. And what goes for our nutritive instincts is even more strongly applicable to our moral ones.\footnote{One
might think that the complexity problem can also be solved in a third way, by adverting to positive law. But Hume himself
noted that the issue comes up with respect to state authority as well.??ref}
\chaptertail 
