...
Nor does it help to reject the idea that there is a threshold needed for respect, but that instead there is a continuous increase
in the reasons for respectful behavior as the intellectual powers rise. For now instead of explaining one threshold, one needs to
...
But of course in reality, both intelligence and respect have many dimensions, so the whole thing becomes much more complex. 
