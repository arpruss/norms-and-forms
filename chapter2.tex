...
\subsection{Interpersonal aggregation of value and population ethics}
...
more than one person, we will need a way of aggregating value between these people. A particularly difficult set
of cases comes up when the number of people in existence varies between the options.

Perhaps the most straightforward option is to \textit{add up} values across the affected population. This faces
several problems. ??summability, repugnance
...
Next, observe that standards of consent necessary to permit one's being treated a certain way vary widely depending on the treatment.
...
Further, we have a set of Mersenne questions regarding who lies within the scope of the state's authority. Typical human states
...
Some readers will disagree with a number of the examples I gave. Double Effect, for instance, is quite controversial, and philosophical
anarchists will deny that any state is such that one morally ought obey its commands as such. But it seems
...
\subsection{Positive law models}
????
