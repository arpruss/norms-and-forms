...
the degrees of relation are relevant to the moral evaluation. (For further discussion of utilitarianism, see ??forwardref.)
...
a special case.} will have a nice answer to this problem. But utilitarianism, as already
noted??backref, has many highly counterintuitive implications. 
...
discussed in Section??backref, this is itself unlikely. Our flourishing seems to consist of a number of incommensurable goods such 
...
determinate and when it is on, on pain of a regress of indeterminacies---see the discussion of vagueness in
??forwardref.
