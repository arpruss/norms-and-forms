...
Leibniz famously recognized God's artistry in a balance of simplicity and diversity. But it is more than a numerical balance.
Different ``areas of reality'' are differently characterized. Physics tends towards simplicity. Chemistry describes a complexity from 
...
Is this a case of the theist disingenuously having it both ways? That depends on how much objectively one sees in aesthetics.
If aesthetics has no objectivity to it whatsoever, is simply an arbitrary human creation, then the above will have little 
force. But aesthetics could have two kinds of objectivity: it could be objective and species-independent or it could be 
objective and species-dependent. In the species-independent version, this is perhaps more evidence. But even in a species-dependent
version, it would make sense for a good God to create a world that would be beautiful \textit{to the creatures in it}.


????????

\section{Final remarks}
We have a variety of harmonies needed for our Aristotelian optimism. The norms themselves fit with each other (both within each 
