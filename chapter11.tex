...
Here is another harmony between morality and happiness. Consider this form of argument for a moral fact $F$:
...
However, there appear to be good cases of this argument in the moral case. For instance, it seems that intelligent social 
animals like us need some sort of a system of punishment in order to counter severe antisocial behavior. But an effective system 
...
was invented. Most people dismiss the argument, and it seems very plausible to dismiss it precisely on the grounds
that it would be very bad for our species---we would need to go extinct---if heterosexual intercourse were 
...
and what moral facts obtain. We thus have multiple types of harmony between flourishing and morality.
