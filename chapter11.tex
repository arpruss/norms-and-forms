...
we not have to sleep in a bed covered in vomit, even though this good is neither virtue nor its exercise~\parencite[215]{Vlastos}.
...
beneficiaries. However, there is a danger in this line of reasoning. As \citeasnoun[21n1]{ClarkeProfiles} famously
...
Famously, \citeasnoun[I.2]{AristotleNE} noted that in ethics, unlike in geometry, one can only speak in ways that are true for the most 
...
no Form of Mud~\parencite{\textit{Parmenides} 130cd}. The reason why the evolved pig-like animals in our world do not have a form that both makes 
