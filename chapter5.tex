...
not appear to be a rational set of epistemic preferences.\footnote{Note that one might argue that when one has credence $p$
in $H$, and $H$ is true, then the value of one's relevant epistemic state is not just $T_{1000}(p)$ but $T_{1000}(p)+F_{1000}(1-p)$,
since one at the same time has a credence $1-p$ in the falsehood $\sim H$, and similarly when $H$ is false, then the
value of one's relevant state is $F_{1000}(p)+T_{1000}(1-p)$. However, this does not change anything, since by symmetry
$T_{1000}(p)+F_{1000}(1-p)=2T_{1000}(p)$ and $F_{1000}(p)+T_{1000}(1-p)=2F_{1000}(p)$, so this consideration simply
doubles every value.}
