...
The question of epistemic value assignment may seem purely theoretical. However, it can have real-world ramifications. 
...
and the logarithmic score. Of these, the logarithmic score is the only that that 

But we should not think that any of these is \textit{the} correct epistemic value assignment. 
