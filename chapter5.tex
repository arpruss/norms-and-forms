...
Suppose a scientist is deciding whether to go home to be with family or perform another experiment at the end of a long day, an experiment that 
cannot be done on another date (maybe the subjects will be unavailable or the chemicals will go bad). 
The scientist is thus weighing the epistemic goods arising from the experiment with the value of interacting
...
On Bayesianism, the interest is not in beliefs as such but in the agent's credences, which come in degrees. The 
...
\section{Bayesianism versus natural law metaepistemology}
