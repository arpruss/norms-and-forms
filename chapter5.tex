...
The subjective Bayesian says that there are no constraints on the priors, and the information-theoretist Bayesian thinks
that considerations of coding can yield a reasonable set of priors.
