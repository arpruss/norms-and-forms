...
Suppose that a spinner is randomly spun, and it comes to a stop at some angle between $0^\circ$, inclusive, and $360^\circ$,
exclusive. Call that angle $X$. Independently of the spinner, a fair coin is tossed. If the coin is tails, the spinner is left
unchanged. If the coin is tails, the spinner is adjusted so that it now points to half of the angle it started with. Call the 
final angle $Y$. All of the above happens out of your sight.

Note that if the coin lands heads, then we are guaranteed to have the final spinner angle $Y < 180^\circ$. Thus, if you were
to learn that $Y\ge 180^\circ$, you would thereby have learned that the coin landed tails. It is a standard result in Bayesian
...
you were to learn that $Y<180^\circ$, that would be evidence against the tails hypothesis, and hence in favor of the heads
one.
