...
Only the last question adverts to epistemic value. It could be that the answers to the preceding questions suffice
...
A sane epistemology thus requires low priors for skeptical hypotheses. But it seems like an anthropocentric cheat to 
build such an anti-skeptical bias into the conditions for our priors. It would be odd to think that our priors should
be such as to ``please us''. 
...
Outside of a natural law metaepistemology, it is difficult to see how one could have an account on which
skeptical hypotheses consistently should have very low priors. Granted, a simplicity-based account 
of priors may be expected to assign a lower probability to the hypothesis $T'$ on which an evil demon makes
things seems as if theory $T$ were true on the grounds that the evil demon complicates the story. But an
evil demon need not \textit{greatly} complicate the story, and may even simplify it in some respects.
...
evil demon or simulation world need not include any of that complexity. Only what's empirically relevant to us
needs to be included in the evil demon's deception or the simulation's computations.

??do we know the skeptical hypotheses false? a priori contingent knowledge...
...
??good enough and better insight!
