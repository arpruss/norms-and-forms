...
\begin{proof}
First consider the case where $T(x)$ is an indicator function of $A\subseteq [0,1]$, where $1_A(x)$ is $1$ if
...
$$
	F_A(x) = -\frac{xT(x)}{1-x}+\int_{1/2}^x \frac{T(u)}{(1-u)^2} \, du
$$
...
\begin{equation}\label{eq:Tint}
	T(x) = \int_{-\infty}^0 T_{A_t} \, dt.
\end{equation}
Let $F$ be as in the statement of the Lemma. Then for $x<1$ we have:
\begin{equation}\label{eq:Fint}
\begin{aligned}
	F(x) &= -\frac{xT(x)}{1-x}+\int_{1/2}^x \frac{T(u)}{(1-u)^2} \, du \\
		 &= -\frac{x}{1-x}\int_{-\infty}^0 T_{A_t} \, dt + \int_{1/2}^x \int_{-\infty}^0 \frac{T_{A_t}}{(1-u)^2} \, dt\, du \\
		 &= \int_{-\infty}^0 \left(-\frac{xT_{A_t}}{1-x}  + \int_{1/2}^x \frac{T_{A_t}}{(1-u)^2} \, du \right) \, dt\\
